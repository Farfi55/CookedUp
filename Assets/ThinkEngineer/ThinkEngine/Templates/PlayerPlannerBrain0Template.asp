...
%s_Plate_KitchenObjectASP_Name(plateSensor,objectIndex(Index),Index1,Value).
%s_Plate_KitchenObjectASP_ID(plateSensor,objectIndex(Index),Index1,Value).
%s_Plate_KitchenObjectASP_ContainerID(plateSensor,objectIndex(Index),Index1,Value).
...
%s_Counter_KitchenObjectASP_ContainerID(counterSensor,objectIndex(Index),Index1,Value).
