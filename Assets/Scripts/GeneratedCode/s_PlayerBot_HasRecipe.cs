...
{
    class s_PlayerBot_HasRecipe : Sensor
    {
		private int counter;
		...
		public override void Initialize(SensorConfiguration sensorConfiguration)
		{
			...
			counter = 0;
			mappingTemplate = "s_PlayerBot_HasRecipe(player,objectIndex("+index+"),{0})." + Environment.NewLine;
		...
		public override void Update()
		{
			...
			if(!invariant || first)
			{
				...
				bool HasRecipe1 = PlayerBotSensorData0.HasRecipe;
				if (values.Count == 200)
				{
						values.RemoveAt(0);
				}
