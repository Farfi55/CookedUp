...
{
    class S_CuttingCounter5 : Sensor
    {
		private int counter;
        ...
        internal static Sensor Instance
        {
            get
            {
                if (instance == null)
                {
					instance = new S_CuttingCounter5();
                }
                return instance;
            }
        }*/
		...
		public override void Initialize(SensorConfiguration sensorConfiguration)
		{
			...
			counter = 0;
			mappingTemplate = "s_CuttingCounter_CurrentCuttingRecipe_InputKOName(cuttingCounterSensor,objectIndex(1),{0})." + Environment.NewLine;
		...
		public override void Update()
		{
			...
			if(!invariant || first)
			{
				...
				string InputKOName2 = CurrentCuttingRecipe1.InputKOName;
				if(InputKOName2 == null) return;

				if (values.Count == 200)
				{
					values.RemoveAt(0);
				}
				values.Add(InputKOName2);
			}
		}
