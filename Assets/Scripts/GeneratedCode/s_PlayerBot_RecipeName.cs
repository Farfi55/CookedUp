...
{
    class s_PlayerBot_RecipeName : Sensor
    {
		private int counter;
		...
		public override void Initialize(SensorConfiguration sensorConfiguration)
		{
			...
			counter = 0;
			mappingTemplate = "s_PlayerBot_RecipeName(player,objectIndex("+index+"),{0})." + Environment.NewLine;
		...
		public override void Update()
		{
			...
			if(!invariant || first)
			{
				...
				string RecipeName1 = PlayerBotSensorData0.RecipeName;
				if(RecipeName1 == null)
				{
					values.Clear();
					return;
