...
{
    class S_CuttingCounter1 : Sensor
    {
		private int counter;
        ...
        internal static Sensor Instance
        {
            get
            {
                if (instance == null)
                {
					instance = new S_CuttingCounter1();
                }
                return instance;
            }
        }*/
		...
		public override void Initialize(SensorConfiguration sensorConfiguration)
		{
			...
			counter = 0;
			mappingTemplate = "s_CuttingCounter_HasAny(cuttingCounterSensor,objectIndex(1),{0})." + Environment.NewLine;
