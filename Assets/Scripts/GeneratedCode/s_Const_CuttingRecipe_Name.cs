...
{
    class s_Const_CuttingRecipe_Name : Sensor
    {
		private int counter;
		...
		public override void Initialize(SensorConfiguration sensorConfiguration)
		{
			...
			counter = 0;
			mappingTemplate = "s_Const_CuttingRecipe_Name(constantsSensor,objectIndex("+index+"),{1},{0})." + Environment.NewLine;
		...
		public override void Update()
		{
			...
			if(!invariant || first)
			{
				...
				for(int i_1 = 0; i_1 < CuttingRecipes1.Count; i_1++)
				{
					...
					string Name2 = CuttingRecipes1[i_1].Name;
					if(Name2 == null)
					{
						values[i_1].Clear();
						continue;
