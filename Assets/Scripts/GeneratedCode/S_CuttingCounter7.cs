...
{
    class S_CuttingCounter7 : Sensor
    {
		private int counter;
        ...
        internal static Sensor Instance
        {
            get
            {
                if (instance == null)
                {
					instance = new S_CuttingCounter7();
                }
                return instance;
            }
        }*/
		...
		public override void Initialize(SensorConfiguration sensorConfiguration)
		{
			...
			counter = 0;
			mappingTemplate = "s_CuttingCounter_CurrentCuttingRecipe_TimeToCut(cuttingCounterSensor,objectIndex(1),{0})." + Environment.NewLine;
		...
		public override void Update()
		{
			...
			if(!invariant || first)
			{
				...
				int TimeToCut2 = CurrentCuttingRecipe1.TimeToCut;

				if (values.Count == 200)
				{
					values.RemoveAt(0);
				}
				values.Add(TimeToCut2);
			}
		}
