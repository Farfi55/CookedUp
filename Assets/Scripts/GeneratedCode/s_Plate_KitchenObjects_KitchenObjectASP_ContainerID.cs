...
{
    class s_Plate_KitchenObjects_KitchenObjectASP_ContainerID : Sensor
    {
		private int counter;
		...
		public override void Initialize(SensorConfiguration sensorConfiguration)
		{
			...
			counter = 0;
			mappingTemplate = "s_Plate_KitchenObjects_KitchenObjectASP_ContainerID(plateSensor,objectIndex("+index+"),{1},{0})." + Environment.NewLine;
