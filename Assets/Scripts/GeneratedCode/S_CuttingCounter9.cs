...
{
    class S_CuttingCounter9 : Sensor
    {
		private int counter;
        ...
        internal static Sensor Instance
        {
            get
            {
                if (instance == null)
                {
					instance = new S_CuttingCounter9();
                }
                return instance;
            }
        }*/
		...
		public override void Initialize(SensorConfiguration sensorConfiguration)
		{
			...
			counter = 0;
			mappingTemplate = "s_CuttingCounter_Name(cuttingCounterSensor,objectIndex(1),{0})." + Environment.NewLine;
