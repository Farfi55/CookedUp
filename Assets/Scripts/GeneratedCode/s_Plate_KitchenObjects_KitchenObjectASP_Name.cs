...
{
    class s_Plate_KitchenObjects_KitchenObjectASP_Name : Sensor
    {
		private int counter;
		...
		public override void Initialize(SensorConfiguration sensorConfiguration)
		{
			...
			counter = 0;
			mappingTemplate = "s_Plate_KitchenObjects_KitchenObjectASP_Name(plateSensor,objectIndex("+index+"),{1},{0})." + Environment.NewLine;
