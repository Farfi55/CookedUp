...
{
    class S_ContainerCounter0 : Sensor
    {
		private int counter;
        ...
        internal static Sensor Instance
        {
            get
            {
                if (instance == null)
                {
					instance = new S_ContainerCounter0();
                }
                return instance;
            }
        }*/
		...
		public override void Initialize(SensorConfiguration sensorConfiguration)
		{
			...
			counter = 0;
			mappingTemplate = "s_ContainerCounter_ID(counterSensor,objectIndex(1),{0})." + Environment.NewLine;
