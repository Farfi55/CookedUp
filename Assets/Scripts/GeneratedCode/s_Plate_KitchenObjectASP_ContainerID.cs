...
{
    class s_Plate_KitchenObjectASP_ContainerID : Sensor
    {
		private int counter;
		...
		public override void Initialize(SensorConfiguration sensorConfiguration)
		{
			...
			counter = 0;
			mappingTemplate = "s_Plate_KitchenObjectASP_ContainerID(kitchenObjectSensor,objectIndex("+index+"),{1},{0})." + Environment.NewLine;
