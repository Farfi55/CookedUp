...
{
    class s_Player_SelectedInteractableType : Sensor
    {
		private int counter;
		...
		public override void Initialize(SensorConfiguration sensorConfiguration)
		{
			...
			counter = 0;
			mappingTemplate = "s_Player_SelectedInteractableType(player,objectIndex("+index+"),{0})." + Environment.NewLine;
		...
		public override void Update()
		{
			...
			if(!invariant || first)
			{
				...
				if(SelectedInteractableType1 == null)
				{
					values.Clear();
					return;
				}
